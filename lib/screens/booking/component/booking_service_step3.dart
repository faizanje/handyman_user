...
class _BookingServiceStep3State extends State<BookingServiceStep3> {
            ...
            child: Column(
              children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Marquee(
                            child: Row(
                              children: [
                                PriceWidget(price: price, size: 18, isBoldText: true, color: textPrimaryColorGlobal),
                                Text(' * $itemCount  = '),
                                PriceWidget(price: price * itemCount, size: 18, isBoldText: true, color: textPrimaryColorGlobal),
                              ],
                            ),
                          ).flexible(flex: 2),
                        ],
                ...
                if (widget.selectedPackage == null)
                  Row(
                    children: [
                      if (widget.data.serviceDetail!.appliedCouponData != null) Text(language.lblCoupon, style: secondaryTextStyle(size: 14)) else Text(language.lblCoupon, style: secondaryTextStyle(size: 16)).expand(),
                ...
                if (widget.data.serviceDetail!.isAdvancePayment)
                  Row(
                    children: [
                      RichTextWidget(
                        list: [
                          TextSpan(text: language.advancePayAmount, style: secondaryTextStyle(size: 16)),
                          TextSpan(
                      ...
                      //Text(language.advancePayAmount, style: secondaryTextStyle(size: 16)).expand(),
  ...
  Widget buildTimeWidget() {
    ...
    return Text(
        TimeOfDay(hour: widget.data.serviceDetail!.bookingSlot.validate().splitBefore(':').split(":").first.toInt(), minute: widget.data.serviceDetail!.bookingSlot.validate().splitBefore(':').split(":").last.toInt())
            .format(context),
