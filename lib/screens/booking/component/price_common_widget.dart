              ...
              children: [
                Row(
                  children: [
                    ...
                    16.width,
                    PriceWidget(price: bookingDetail.amount.validate(), size: 16, color: textPrimaryColorGlobal, isBoldText: true),
                  ],
                ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Marquee(
                            child: Row(
                              children: [
                                PriceWidget(price: bookingDetail.amount.validate(), size: 16, isBoldText: false, color: appTextSecondaryColor),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          16.width,
                          PriceWidget(price: serviceDetail.taxAmount!, size: 16, color: Colors.red, isBoldText: true),
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          PriceWidget(price: serviceDetail.couponDiscountAmount.validate(), size: 16, color: Colors.green, isBoldText: true, isDiscountedPrice: true),
                        ],
                      ),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      Text.rich(TextSpan(children: [
                        TextSpan(text: language.advancePayment, style: secondaryTextStyle(size: 16)),
                        TextSpan(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      bookingDetail.status == BookingStatusKeys.complete && bookingDetail.paymentStatus == SERVICE_PAYMENT_STATUS_PAID
                          ...
                          : PriceWidget(price: getRemainingAmount, color: primaryColor, size: 18),
                    ],
                  ),
